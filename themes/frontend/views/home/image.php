...
<div class="content-container">
	<div class="page-library album">
		<!-- BOX COMMON INTRODUCE -->
		<div class="wrap-box photo-activity">
			<div class="img-decoration decoration-09 decoration-middle-left"></div>
			<div class="img-decoration decoration-02 decoration-top-right"></div>
			<div class="img-decoration decoration-10 decoration-bottom-right"></div>
			<div class="wrap-title">
				<div class="inner">
					<h1 class="title">Thư viện ảnh</h1>
				</div>
			</div>
			<div class="box">
			<?php if(!empty($arrImage)){ ?>
				<ul class="list-img list-img-popup">
					<?php foreach($arrImage as $image){ ?>
					<li>
						<a href="<?php echo Yii::app()->baseUrl; ?>/upload/images/<?php echo $image['image'];?>">
							<img src="<?php echo getImage($image->image, 263, 121); ?>" alt="img" width="265" height="122">
							<p title="<?php echo $image->name; ?>"><?php echo word_limiter($image->name, 15); ?></p>
						</a>
					</li>
					<?php } ?>
				</ul>
			<?php }else echo "Không tìm thấy hình ảnh!"; ?>
				<div class="wrap-pagination">
					<?php if( $item_count > 16){ ?>
					<p>Trang: </p>
					<?php } ?>
					<?php
