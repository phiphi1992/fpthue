...
<div class="content-container">
	<div class="page-parents page-news">
		...
		<div class="wrap-box notice news">
			...
			<?php if(!empty($arrNew)){ ?>
				...
				<?php for($i=0; $i<ceil(count($arrNew)/5); $i++){ ?>
					<ul class="list-has-bg-item">
						<li>
							<a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$arrNew[$i]->alias)); ?>"><img src="<?php echo getImage($arrNew[$i]->image, 555, 255); ?>" alt="img" width="550" height="253"></a>
							<div class="content-detail">
								<h4 title="<?php echo $arrNew[$i]->name; ?>"><a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$arrNew[$i]->alias)); ?>"><?php echo word_limiter($arrNew[$i]->name, 15); ?></a></h4>
								<p><?php echo word_limiter($arrNew[$i]->description,55 )." "; ?><a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$arrNew[$i]->alias)); ?>" class="view-more">Xem thêm</a></p>
								<p class="date-post"><?php echo "Đăng ngày ".date("d/m/Y",$arrNew[$i]->created); ?></p>
							</div>
						</li>
					</ul>
				<?php } ?>
				...
				<div class="col-item-md">
					<ul class="list-has-bg-item">
					<?php $k=0; ?>
					<?php for($i=ceil(count($arrNew)/5); $i<count($arrNew); $i++){ ?>
						<li>
							<a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$arrNew[$i]->alias)); ?>"><img src="<?php echo getImage($arrNew[$i]->image, 555, 255); ?>" alt="img" width="550" height="253"></a>
							<div class="content-detail">
								<h4 title="<?php echo $arrNew[$i]->name; ?>"><a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$arrNew[$i]->alias)); ?>"><?php echo word_limiter($arrNew[$i]->name, 15); ?></a></h4>
