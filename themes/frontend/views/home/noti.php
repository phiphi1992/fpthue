...
<div class="content-container">
	<div class="page-parents page-news">
		...
		<div class="wrap-box notice news">
			...
			<div class="box">
			<?php if(!empty($arrNoti)){ ?>
				<div class="col-item-lg">
				<?php for($i=0; $i<ceil(count($arrNoti)/5); $i++){ ?>
					<ul class="list-has-bg-item">
						<li>
							<a href="<?php echo PIUrl::createUrl('/home/notiDetail', array("alias"=>$arrNoti[$i]->alias)); ?>"><img src="<?php echo getImage($arrNoti[$i]->image, 555, 255); ?>" alt="img" width="550" height="253"></a>
							<div class="content-detail">
								<h4><a href="<?php echo PIUrl::createUrl('/home/notiDetail', array("alias"=>$arrNoti[$i]->alias)); ?>"><?php echo $arrNoti[$i]->name; ?></a></h4>
								<p><?php echo $arrNoti[$i]->description; ?> ... <a href="#" class="view-more">Xem thêm</a></p>
								<p class="date-post"><?php echo "Đăng ngày ".date("d/m/Y",$arrNoti[$i]->created); ?></p>
							</div>
						</li>
					</ul>
				<?php } ?>
				...
				<div class="col-item-md">
					<ul class="list-has-bg-item">
					<?php $k=0; ?>
					<?php for($i=ceil(count($arrNoti)/5); $i<count($arrNoti); $i++){ ?>
						<li>
							<a href="<?php echo PIUrl::createUrl('/home/notiDetail', array("alias"=>$arrNoti[$i]->alias)); ?>"><img src="<?php echo getImage($arrNoti[$i]->image, 555, 255); ?>" alt="img" width="550" height="253"></a>
							<div class="content-detail">
								<h4><a href="<?php echo PIUrl::createUrl('/home/notiDetail', array("alias"=>$arrNoti[$i]->alias)); ?>"><?php echo $arrNoti[$i]->name; ?></a></h4>
