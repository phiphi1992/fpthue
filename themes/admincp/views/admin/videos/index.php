<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo translate('Danh sách video');?></li>
		</ul>
	</div>
	...
	<div class="page-content">
		<div class="page-header position-relative">
			<h1>
				<?php echo translate('Danh sách video');?>
			</h1>
		</div><!--/.page-header-->
		<div class="row-fluid">
			<div class="span12">
			<a href="<?php echo PIURl::createUrl('admin/videos/create');?>" class="btn btn-primary">
					<i class="icon-ok bigger-110"></i>Thêm
				</a>
				<!--PAGE CONTENT BEGINS-->
	...
	$("document").ready(function(){
		$(".deleteAll").live('click', function(){
			...
			if(arrIdNew != ""){
				...
				if(answer){
					var arrIdNew = $("#categriesnews-grid").yiiGridView('getSelection');
					var url = '<?php echo PIUrl::createUrl("/admin/videos/deleteAll/id");?>';
					url+='/'+arrIdNew;
