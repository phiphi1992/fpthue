<div class="main-content">
	...
	<div class="page-content">
		<div class="page-header position-relative">
			<h1>
				<?php echo translate('Danh sách đối tác');?> <a href="<?php echo PIUrl::createUrl('/admin/images/addPatner');?>"><button class="btn btn-small btn-primary">Thêm</button></a>
			</h1>
		</div><!--/.page-header-->
		<div class="row-fluid">
			<div class="span12">
			<form method="POST" action="<?php echo PIUrl::createUrl('/admin/images/patner');?>">
						...
						<tr>
							...
							<td>
								<div class="hidden-phone visible-desktop btn-group">
									<a href="<?php echo PIUrl::createUrl('/admin/images/editPatner',array('id'=>$image->id));?>">
