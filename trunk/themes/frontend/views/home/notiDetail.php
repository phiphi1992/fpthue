...
<div class="content-container">
	<div class="page-parents page-news page-news-detail">
		...
		<div class="wrap-box notice news related">
			<div class="wrap-title">
				<div class="inner">
					<h1 class="title">Thông báo liên quan</h1>
				</div>
			</div>
			...
			<?php if(!empty($arrNew)){ ?>
				...
				<?php foreach($arrNew as $new){ ?>
					<li>
						<a href="<?php echo PIUrl::createUrl('/home/notiDetail', array("alias"=>$new->alias)); ?>"><img src="<?php echo getImage($new->image, 261, 120); ?>" alt="img" width="265" height="122"></a>
						<div class="content-detail">
							<h4><a href="<?php echo PIUrl::createUrl('/home/notiDetail', array("alias"=>$new->alias)); ?>"><?php echo $new->name; ?></a></h4>
							<p class="date-post"><?php echo "Đăng ngày ".date("d/m/Y",$new->created); ?></p>
						</div>
					</li>
				<?php } ?>
