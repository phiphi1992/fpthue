		...
		<div class="wrap-box notice news related">
			...
			<?php if(!empty($arrNew)){ ?>
				...
				<?php foreach($arrNew as $new){ ?>
					<li>
						<a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$new->alias)); ?>"><img src="<?php echo getImage($new->image, 261, 120); ?>" alt="img" width="265" height="122"></a>
						<div class="content-detail">
							<h4 title="<?php echo $new->name; ?>"><a href="<?php echo PIUrl::createUrl('/home/newDetail', array("alias"=>$new->alias)); ?>"><?php echo word_limiter($new->name, 15); ?></a></h4>
							<p class="date-post"><?php echo "Đăng ngày ".date("d/m/Y",$new->created); ?></p>
						</div>
					</li>
				<?php } ?>
