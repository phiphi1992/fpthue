...
<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl;?>/assets/toastmessage/resources/css/jquery.toastmessage.css" />
...
<script src="<?php echo Yii::app()->theme->baseUrl;?>/assets/toastmessage/javascript/jquery.toastmessage.js"></script>
<!--ace scripts-->
