    ...
    public function publishAssets() {
        ...
        if (is_dir($assets)) {
            ...
            $messages = CJavaScript::encode(array(
                'fileupload' => array(
                    'errors' => array(
                        "maxFileSize" => $this->t('Tập tin quá lớn'),
                        "minFileSize" => $this->t('Tập tin quá nhỏ'),
                        "acceptFileTypes" => $this->t('Filetype not allowed'),
                        "maxNumberOfFiles" => $this->t('Vượt quá tối đa số tập tin cho phép'),
                        "uploadedBytes" => $this->t('Tập tin vượt quá dung lượng cho phép'),
                        "emptyResult" => $this->t('Tập tin tải lên rỗng'),
                    ),
                    'error' => $this->t('Lỗi'),
                    'start' => $this->t('Tải lên'),
                    'cancel' => $this->t('Hủy bỏ'),
                    'destroy' => $this->t('Xóa'),
                ),
            ));
