...
class UserModule extends CWebModule
{
	...
	*/
	public $layout = 'user.views.layout.main';
	/**
	...
	*/
	...
	public static function sendMail($email,$subject,$message) {
	    ...
	    $message = str_replace("\n.", "\n..", $message);
		$send = Yii::app()->mail->sendMailWithTemplate($email,'=?UTF-8?B?'.base64_encode($subject).'?=','forgot_pass',array('message'=>$message));
	    return $send;
