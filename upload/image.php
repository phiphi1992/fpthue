...
if(! defined('PHOTO_ROOT') )			define('PHOTO_ROOT', '/mam-non-kovo/upload/images/');
if(! defined('PHOTO_PATH') )			define('PHOTO_PATH', $_SERVER['DOCUMENT_ROOT'].'/mam-non-kovo/upload/images/');
/*
