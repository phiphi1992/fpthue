...
class XUploadForm extends CFormModel
{
        ...
        */
        ...
        public function rules()
        {
                return array(
                        //array('file', 'file'),
						array('file', 'file', 'allowEmpty'=>true, 'types'=>'jpg,jpeg,gif,png', 'maxSize'=>1024 * 1024 * 2, 'tooLarge'=>'Dung lượng tập tin không được quá 2MB','wrongType'=>'Tập tin "{file}" không đúng định dạng, chỉ cho phép tải hình ảnh (png,gif,jpg)'),
                );
        }
